...
Given a tabular data(values of x and y) for y = ax + b/x
Fit these points(x,y).
Determine suitable values of a and b for the curve y = ax + b/x. Also calculate error.
*/
...
int main() {
    ...
    for(i=0; i<m; i++)
    {
        cal_y = a0*xx[i] + (long double)a1 / xx[i];
