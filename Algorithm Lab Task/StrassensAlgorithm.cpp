    ...
    else
    {
        ...
        vector<vector<int>>
                         ...
                         c11(new_size, z),      c12(new_size, z), c21(new_size, z), c22(new_size, z),
                          p1(new_size, z),       p2(new_size, z), p3(new_size, z),   p4(new_size, z), //formula of p
                          p5(new_size, z),       p6(new_size, z), p7(new_size, z),
                     aResult(new_size, z), bResult(new_size, z);

        int i, j;

        for (i = 0; i < new_size; i++) //dividing the matrices into sub-matrices:
        {
...
int main()
{
    ...
    Strassen_algorithm(mat1, mat2, n1, m1, n2, m2);
    return 0;
}
